...
func (_m *MockUsersCache) Get(ctx context.Context, id int64) (*User, error) {
...
func (_c *MockUsersCache_Get_Call) Return(_a0 *User, _a1 error) *MockUsersCache_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUsersCache_Get_Call) RunAndReturn(run func(context.Context, int64) (*User, error)) *MockUsersCache_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Set provides a mock function with given fields: ctx, user
func (_m *MockUsersCache) Set(ctx context.Context, user *User) error {
...
func (_c *MockUsersCache_Set_Call) Run(run func(ctx context.Context, user *User)) *MockUsersCache_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockUsersCache_Set_Call) RunAndReturn(run func(context.Context, *User) error) *MockUsersCache_Set_Call {
	_c.Call.Return(run)
	return _c
}
